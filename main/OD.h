...
********************************************************************************
    ...
    File info:
        ...
        Project File: energyflow.xdd
        File Version: 24.04.1

        Created:      11/04/2024 18:21:31
        Created By:   Marek Kida
        Modified:     11/04/2024 23:13:41
        Modified By:  Marek Kida

    Device Info:
        Vendor Name:  HydrogreenTeam
        Vendor ID:    2137
        Product Name: Energy Flow Unit
        Product ID:   0003

        Description:  CANOpen dictionary for Hydros EF
*******************************************************************************/
...
typedef struct {
    ...
    float32_t x6400_vehicleSpeedFromMCU;
} OD_RAM_t;
...
#define OD_ENTRY_H6400 &OD->list[19]
...
#define OD_ENTRY_H6400_vehicleSpeedFromMCU &OD->list[19]
