...
static const size_t CONVERSION_SAMPLES_LENGTH = 128;
...
static bool IRAM_ATTR on_adc_conversion_done(adc_continuous_handle_t handle, const adc_continuous_evt_data_t *edata, void *user_data)
{
